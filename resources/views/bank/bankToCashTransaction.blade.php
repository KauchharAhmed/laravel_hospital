 ...
 <div class="col-md-6">
                                ...
                                <div class="portlet box blue">
                                    <div class="portlet-title">
                                        <div class="caption">
                                        Amount Transfer From Bank Account To Cash </div>
                                    </div>
                                    <div class="portlet-body form">
                                        	 {!! Form::open(['url' =>'bankToCashTransactionInfo','method' => 'post','role' => 'form','class'=>'form-horizontal','files' => true]) !!}
                                            <div class="form-body">
                                                <div class="form-group">
                                                    <label class="col-md-4 control-label">Select Bank <span style="color:red; font-weight: bold">*</span></label>
                                                    <div class="col-md-8">
                                                        <select class="form-control spinner selectpicker" data-live-search="true" name="bank_name" id="bank_name" required="">
                                                    ...
                                                    <div class="form-group">
                                                    <label class="col-md-4 control-label">Available Bank Amount </label>
                                                    <div class="col-md-8">
                                                        <input type="text" class="form-control spinner" name="available_bank_amt" id="available_bank_amt" readonly="">
                                                    </div>
                                                </div>
                                                 <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                 ...
                                                 <div class="form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input type="text" class="form-control spinner" name="receipt" placeholder="Check No"></div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                 ...
                                                 <div class="form-group">
                                                    <label class="col-md-4 control-label">Check Copy</label>
                                                    <div class="col-md-8">
