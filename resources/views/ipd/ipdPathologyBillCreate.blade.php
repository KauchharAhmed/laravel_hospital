                                              ...
                                              <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                  ...
                                                  <div class="form-group">
                                                    <label class="col-md-4 control-label"></label>
                                                    <div class="col-md-8">
                                                       <button type="button" id="bill_create" class="form-control spinner btn btn-primary">CREATE IPD PATHOLOGY BILL</button>
                                                      </div>
                                                </div>
                                              </form>
    ...
    function pur_form_clear(){
      ...
      $('#bill_create').click(function(){
            ...
            if(total_amount == '0.00'){
                alert('Invoice Is Empty. Add At Least One Pathology Test');
                return false ;
            }
        ...
        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
           ...
           $.ajax({
           type:'post',
           url:"{{ url('/createIPDPathologyBill') }}",
           async: false,
           dataType:'text',
           cache: false,
           data:{
            ...
            success:function(data){
              ...
              location.href = "{{url('/ipdPathologyBillCreate')}}";
              window.open("{{url('/printIpdPathologyBill') }}/"+data);
            }
            },
            error:function(){
