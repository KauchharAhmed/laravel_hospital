                                    ...
                                    <div class="portlet-body form">
                                            ...
                                            <div class="form-body">
                                               <div class="form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                      <select class="form-control spinner selectpicker" data-live-search="true" name="doctor_id" id="doctor_id" required="">
                                                          <option value="">Select Doctor</option>
                                                          <?php foreach ($doctor as $doctor_value) { ?>
                                                           <option value="<?php echo $doctor_value->id ;?>"><?php echo $doctor_value->name ; ?></option>
                                                           <?php } ?>
                                                      </select>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                      <select class="form-control" name="product" id="product" required="" data="product_id">
                                                ...
                                                <input class="form-control m-input" type="hidden" name="item" id ="item">
                                                    <div class="form-group">
                                                    <label class="col-md-4 control-label">Selected OPD Category</label>
                                                    <div class="col-md-8">
                                              ...
                                              <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                  ...
                                                  <div class="form-group">
                                                    <label class="col-md-4 control-label"></label>
                                                    <div class="col-md-8">
                                                       <button type="button" id="bill_create" class="form-control spinner btn btn-primary">CREATE OPD BILL</button>
                                                      </div>
                                                </div>
                                              </form>
...
<script>
      ...
      $("#doctor_id").change(function(e){
       ...
       $.ajax({
        'url':"{{ url('/getOpdCategoryOfThisDoctor') }}",
        'type':'post',
        'dataType':'text',
        data:{  
        doctor_id:doctor_id
        ...
        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
           ...
           data:{
            ...
            success:function(data){
                ...
                $("#bill_create").attr("disabled",false);
                alert('Sorry , Invoice Category Item Will Be One');
                return false;
              }else if(data == 'p1'){
                $("#bill_create").attr("disabled",false);
              ...
              location.href = "{{url('/opdBillCreate')}}";
              window.open("{{url('/printA4OpdBill')}}/"+data);
            }
            },
            error:function(){
