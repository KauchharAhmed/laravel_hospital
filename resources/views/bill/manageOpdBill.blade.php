                                ...
                                <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class="caption font-dark">
                                            ...
                                            <span class="caption-subject bold uppercase">OPD Bill List</span>
                                        </div>
                                        <div class="tools"> </div>
                                    </div>
                                        ...
                                        <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                                            ...
                                            <tbody>
                                                ...
                                                <?php endif;?>
                                                   ...
                                                   <?php
                                                   // payable amount info
                                                    $bill_tr_info = DB::table('opd_bill_transaction')->where('branch_id',$branch_id)->where('invoice_number',$value->invoice)->get();
                                                   $total_payable  = 0 ;
                                                   $total_payment  = 0 ;
                                                   $total_discount = 0 ;
                                                   $total_rebate   = 0 ;
                                                      ...
                                                      <td><?php echo number_format($total_discount,2); ?></td>
                                                       <td><?php echo number_format($total_rebate,2); ?></td>
                                                        <td><?php echo number_format($total_payment,2); ?></td>
                                                         ...
                                                         ?></td>
                                                         <td>
                                                    <a target="_blank" href="{{URL::to('printOpdBill/'.$value->invoice.'/'.$value->id)}}"><button type="button" class="btn btn-info btn-sm">PRINT INVOICE</button></a>
                                                    </td>
                                                    <!--<td>
