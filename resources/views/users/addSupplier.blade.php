 ...
 <div class="col-md-6">
                                ...
                                <div class="portlet box blue">
                                    <div class="portlet-title">
                                        <div class="caption">
                                          Add Medical Product Supplier
                                      </div>
                                    </div>
                                    <div class="portlet-body form">
                                             {!! Form::open(['url' =>'addSupplierInfo','method' => 'post','role' => 'form','class'=>'form-horizontal','files' => true]) !!}
                                            <div class="form-body">

                                                  <div class="form-group">
                                                    <label class="col-md-4 control-label">Supplier Name <span style="color:red; font-weight: bold">*</span></label>
                                                    <div class="col-md-8">
                                                    ...
                                                    <div class="form-group">
                                                    <label class="col-md-4 control-label">Supplier Mobile <span style="color:red; font-weight: bold">*</span></label>
                                                    <div class="col-md-8">
                                                  ...
                                                  <div class="form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input type="text" class="form-control spinner" name="contact_person_name">
                                             
                                                </div>
                                              </div>
                                                    <div class="form-group">
                                                    <label class="col-md-4 control-label">Contact Person Mobile</label>
                                                    <div class="col-md-8">
                                                        <input type="text" class="form-control spinner" name="contact_person_mobile">
                                                 ...
                                                 <div class="form-group">
                                                  ...
                                                  <div class="form-group">
                                                   <label class="col-md-4 control-label">Previous Due Date<span style="color:red; font-weight: bold">*</span></label>
                                                    ...
                                                    <div class="form-group">
                                                    <label class="col-md-4 control-label">Logo / Image</label>
                                                    <div class="col-md-8">
