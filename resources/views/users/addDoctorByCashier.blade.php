 ...
 <div class="col-md-6">
                                ...
                                <div class="portlet box blue">
                                    ...
                                    <div class="portlet-body form">
                                             {!! Form::open(['url' =>'addDoctorInfo','method' => 'post','role' => 'form','class'=>'form-horizontal','files' => true]) !!}
                                            <div class="form-body">
                                                  <div class="form-group">
                                                    <label class="col-md-4 control-label"> Doctor Name <span style="color:red; font-weight: bold">*</span></label>
                                                    <div class="col-md-8">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input type="text" class="form-control spinner" name="specialist" required="">
                                               ...
                                               <div class="form-group">
                                                  ...
                                                  <div class="form-group">
                                                    <label class="col-md-4 control-label">Doctor Mobile (Log In Id)<span style="color:red; font-weight: bold">*</span></label>
                                                    <div class="col-md-8">
                                                 ...
                                                 <div class="form-group">
                                                    <label class="col-md-4 control-label">Doctor Type<span style="color:red; font-weight: bold">*</span></label>
                                                    <div class="col-md-8">
                                                        <select class="form-control spinner" name="doctor_type" required="">
                                                          <option value="">Select Doctor Type</option>
                                                          <option value="1">Not Surgeon</option>
