 ...
 <div class="col-md-10">
                                ...
                                <div class="portlet box blue">
                                    ...
                                    <div class="portlet-body form">
                                             {!! Form::open(['url' => 'supplierPaymentAmt','role' => 'form','class'=>'form-horizontal']) !!}
                                            <div class="form-body">
                                                <div class="form-group">
                                                    <label class="col-md-4 control-label">Select Supplier<span style="color:red; font-weight: bold">*</span></label>
                                                    <div class="col-md-8">
                                                             <select class="form-control spinner selectpicker" data-live-search="true" name="supplier_id" id="supplier_id" data="supplier_id" required="">
                                                             <option value="">Select Supplier</option>
                                                             <?php
                                                             foreach ($supplier as $supplier_value) { ?>
                                                             <option value="<?php echo $supplier_value->id;?>"><?php echo $supplier_value->supplier_name.' -> '.$supplier_value->mobile;?></option>
                                                             <?php } ?> 
                                                      </select>
                                                    </div>
                                                </div> 
