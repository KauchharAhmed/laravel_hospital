                                                       ...
                                                       <label class="col-md-1 control-label"> Bill No</label>
                                                        <div class="col-md-2">
                                                         <select class="form-control spinner selectpicker" data-live-search="true" id="bill">
                                                           ...
                                                           <option value="<?php echo $value->id;?>">IPDA - <?php echo $value->invoice;?> </option>
                                                           <?php } ?>
                                                         </select>
                                                      </div>
                                                       
                                                       <div class="col-md-1">
                                                        <button  type="button" class="btn btn-info btn-sm" id="report" >SEARCH TO PRINT</button>
                                                      </div>
                                                </div>
                                       </form>
                                </div>
...
@section('js')
   <script>
     $('#report').click(function(e){
       ...
       $.ajax({
        'url':"{{ url('/cashierIpdAdmissionBillViewForPrint') }}",
        'type':'post',
        'dataType':'text',
        data:{  
        from_date:from_date ,
