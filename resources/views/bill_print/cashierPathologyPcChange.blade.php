                                                    ...
                                                    <div class="col-md-2">
                                                      ...
                                                      <label class="col-md-1 control-label">To <span style="color:red; font-weight: bold">*</span></label>
                                                       ...
                                                       <label class="col-md-1 control-label"> Bill No</label>
                                                        <div class="col-md-2">
                                                         <select class="form-control spinner selectpicker" data-live-search="true" id="bill">
                                                           <option value="">All</option>
                                                           <?php foreach ($bill as $value) { ?>
                                                           <option value="<?php echo $value->invoice;?>">PAT - <?php echo $value->invoice;?> </option>
                                                           <?php } ?>
                                                         </select>
                                                      </div>
                                                       
                                                       <div class="col-md-1">
                                                        <button  type="button" class="btn btn-info btn-sm" id="report" >SEARCH TO PC CHANGE</button>
                                                      </div>
                                                </div>
                                       </form>
                                </div>
...
@section('js')
   <script>
     $('#report').click(function(e){
       ...
       $.ajax({
        'url':"{{ url('/cashierPathologyBillViewForPCChange') }}",
        'type':'post',
        'dataType':'text',
        data:{  
        from_date:from_date ,
