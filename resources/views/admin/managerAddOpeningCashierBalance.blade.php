 ...
 <div class="col-md-6">
                                ...
                                <div class="portlet box blue">
                                    <div class="portlet-title">
                                        <div class="caption">
                                          Add Cashiers Opening Balance </div>
                                    </div>
                                    <div class="portlet-body form">
                                        	 {!! Form::open(['url' =>'addCashierOpeningBalanceInfo','method' => 'post','role' => 'form','class'=>'form-horizontal']) !!}
                                            <div class="form-body">

                                                <div class="form-group">
                                                    <label class="col-md-4 control-label">Amount<span style="color:red; font-weight: bold">*</span></label>
                                                    <div class="col-md-8">
                                                        <input type="number" class="form-control spinner" name="amount" placeholder="Amount" required=""></div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-md-4 control-label">Confirm Amount <span style="color:red; font-weight: bold">*</span></label>
                                                    <div class="col-md-8">
                                                        <input type="number" class="form-control spinner" name="confirm_amount" placeholder="Confirm_amount" required=""></div>
                                                </div>
                                                   <div class="form-group">
