 ...
 <div class="col-md-6">
                                ...
                                <div class="portlet box blue">
                                    <div class="portlet-title">
                                        <div class="caption">
                                        OPD Bill Due Collect
                                      </div>
                                    </div>
                                    <div class="portlet-body form">
                                             {!! Form::open(['url' =>'opdDueCollectInfo','method' => 'post','role' => 'form','class'=>'form-horizontal']) !!}
                                            <div class="form-body">
                                                 <div class="form-group">
                                                    <label class="col-md-4 control-label">Select Due Bill<span style="color:red; font-weight: bold">*</span></label>
                                                    <div class="col-md-8">
                                                        <select class="form-control spinner orm-control spinner selectpicker" data-live-search="true" name="invoice" id="invoice" required="">
                                                          <option value="">Select Bill</option>
                                                          <?php foreach ($due_invoice as $due_invoice_value) {?>
                                                            <option value="<?php echo $due_invoice_value->invoice ?>">OPD - #<?php echo $due_invoice_value->invoice;?></option>
                                                          <?php } ?>
                                                        </select>
                                                </div>
                                              </div>
                                                    ...
                                                    <div class="col-md-8">
                                                        <textarea type="text" class="form-control spinner" name="patient_info" id="patient_info" readonly="" style="color:green;"></textarea>
                                                        </div>
                                                </div>
                                                 <div class="form-group">
                                                    <label class="col-md-4 control-label">Total Bill Amt</label>
                                                    <div class="col-md-8">
                                                        <input type="text" name="total_amount" id="total_amount" class="form-control spinner" readonly="">
                                                        </div>
                                                </div>
                                                 <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                        <button type="submit" class="btn green">OPD Due Collect</button>
                                                    </div>
                                                </div>
                                        {!! Form::close() !!}
                                </div>
...
<script>
    $('#invoice').change(function(e){
      ...
      $("[name=invoice]").change(function(e){
       ...
       $.ajax({
        'url':"{{ url('/getOpdInvoiceCalculation') }}",
        'type':'post',
        'dataType':'text',
        data:{  
        invoice:invoice
