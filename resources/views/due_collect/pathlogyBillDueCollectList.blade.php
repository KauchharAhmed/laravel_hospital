                    ...
                    <div class="page-content">
                        ...
                        <div class="page-bar">
                            <ul class="page-breadcrumb">
                                <li>
                                   PATHOLOGY BILL DUE COLLECT LIST
                                ...
                                <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class="caption font-dark">
                                            ...
                                            <span class="caption-subject bold uppercase"> Pathology Bill Due Collect List</span>
                                        </div>
                                        <div class="tools"> </div>
                                    </div>
                                        ...
                                        <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <?php
                                                    $invoice_info_query = DB::table('pathology_bill')->where('branch_id',$value->branch_id)->where('invoice',$value->invoice_number)->first();
