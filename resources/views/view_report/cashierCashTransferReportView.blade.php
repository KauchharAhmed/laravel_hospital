                                ...
                                <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class="caption font-dark">
                                          ...
                                          ?>
                                          CASH TRANSFER REPORT BETWEEN FROM <?php echo date('d M Y',strtotime($from_date)) ;?> TO <?php echo date('d M Y',strtotime($to_date)) ; ?>
                                          <?php 
                                          echo "FOR ";
                                          if($transfer_type == '0'){
                                            echo "PENDING";
                                        ...
                                        {!! Form::open(['url' =>'printCashierCashTransferReport','method' => 'post','role' => 'form','class'=>'form-horizontal','target'=>'_blank']) !!}
                                                ...
                                                <tr>
                                                  ...
                                                  <?php elseif($value->status == '1'):?>
                                                    ...
                                                    <td>
                                                      ...
                                                      <a href="{{URL::to('cashierDeletePendingCashTransfer/'.$value->id.'/'.$value->status)}}"><button type="button" class="btn btn-danger btn-sm" onclick="return confirm('Are You Sure You Want To Delete It ?')">DELETE</button></a>
                                                      <?php } ?>
                                                    </td> 
                                                    <?php } ?> 
                                                </tr>
