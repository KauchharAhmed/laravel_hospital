...
@endif
<div class="row">
   {!! Form::open(['url' =>'ipdPatientLedger','method' => 'post','role' => 'form','class'=>'form-horizontal','files' => true]) !!}
                    <div class="col-md-6">
                                               ...
                                               <div class="form-group select_cabin_type" style="display: none;">
                                                 ...
                                                 <div class="form-group select_ward" style="display: none;">
                                                   ...
                                                   <div class="form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                        <button type="submit" class="btn green">Current IPD Patient Ledger</button>
                                                    </div>
                                                </div>
