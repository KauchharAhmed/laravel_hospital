                                ...
                                <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class="caption font-dark">
                                            ...
                                            <span class="caption-subject bold uppercase">PC Ledger</span>
                                        </div>
                                        <div class="tools"> </div>
                                    </div>
                                    <div class="row">
                            ...
                            <div class="porlets-content">
                                <table style="font-size:14px;">
                                    ...
                                    <tr>
                                        ...
                                        <td>:&nbsp;&nbsp;</td>
                                        <td><?php echo $pc->address ; ?></td>
                                    </tr>
                                    <tr>
                                        <td><strong>Mobile</strong></td>
                                        <td>:&nbsp;&nbsp;</td>
                                        <td><?php echo $pc->mobile ; ?></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <table class="nila" width="100%">
                                        ...
                                        <tbody role="alert" aria-live="polite" aria-relevant="all">
                                            ...
                                            <tr class="nila">
                                                ...
                                                <td class="nila"><?php 
                                                   $previous_colum_duee = DB::table('pc_ledger')->where('branch_id',$branch_id)->where('pc_id',$value->pc_id)->where('created_at','<=',$value->created_at)->orderby('created_at','asc')->limit($key)->get();
