 ...
 <div class="col-md-6">
                                ...
                                <div class="portlet box blue">
                                    ...
                                    <div class="portlet-body form">
                                        	 {!! Form::open(['url' =>'addCabinRoomInfo','method' => 'post','role' => 'form','class'=>'form-horizontal']) !!}
                                            <div class="form-body">
                                               ...
                                               <div class="form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                             <select class="form-control spinner selectpicker" data-live-search="true" name="cabin_type_id" required="">
                                                             <option value="">Select Type</option>
                                                             <?php
                                                             foreach ($cabin_type as $cabin_type_value) { ?>
                                                             <option value="<?php echo $cabin_type_value->id;?>"><?php echo $cabin_type_value->cabin_type_name ;?></option>
                                                             <?php } ?> 
                                                      </select>
                                                    </div>
                                                </div> 
                                                <div class="form-group">
                                                    <label class="col-md-4 control-label">Room No <span style="color:red; font-weight: bold">*</span></label>
                                                    <div class="col-md-8">
                                                        <input type="text" class="form-control spinner" name="name" placeholder="Room No" required=""></div>
                                                </div>
                                                <div class="form-group">
