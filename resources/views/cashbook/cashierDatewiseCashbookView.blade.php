                                    ...
                                    <div class="portlet-body">
                                        ...
                                        <tbody role="alert" aria-live="polite" aria-relevant="all">
                                           ...
                                           <tr class="nila">
                                            ...
                                            <?php 
                                              $previous_colum_balance = DB::table('cashbook')->where('branch_id',$branch_id)->where('admin_type',3)->whereNotIn('tr_status',[2])->where('created_at','<=',$value->created_at)->whereBetween('created_at', [$next_form, $to])->orderby('created_at','asc')->limit($key)->get();
