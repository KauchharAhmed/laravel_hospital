                                ...
                                <table class="nila" width="100%" border="1">
                                        ...
                                        <tbody role="alert" aria-live="polite" aria-relevant="all">
                                           ...
                                           foreach ($result as $value) { ?>
                                            ...
                                            <?php 
                                              $count = DB::table('cashbook')->where('branch_id',$branch_id)->where('admin_type',2)->whereNotIn('tr_status',[2])->where('id','<',$value->id)->where('created_at', $rcdate)->count();
                                                if($count > 0){
                                                     $previous_colum_balance = DB::table('cashbook')->where('branch_id',$branch_id)->where('admin_type',2)->whereNotIn('tr_status',[2])->where('id','<',$value->id)->orderby('id','desc')->get();
                                                  ...
                                                  $first_row = DB::table('cashbook')->where('branch_id',$branch_id)->where('admin_type',2)->whereNotIn('tr_status',[2])->where('created_at', $rcdate)->orderby('id','asc')->first();
