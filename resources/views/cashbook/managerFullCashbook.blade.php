                                ...
                                <table class="nila" width="100%" border="1">
                                        ...
                                        <tbody role="alert" aria-live="polite" aria-relevant="all">
                                            ...
                                            <tr class="nila">
                                                ...
                                                <td class="nila" style="padding: 5px">
                                               <?php 
                                               $previous_colum_balance = DB::table('cashbook')->where('branch_id', $branch_id)->where('admin_type',2)->whereNotIn('tr_status',[2])->where('created_at','<=',$value->created_at)->orderby('created_at','asc')->limit($key)->get();
