                    ...
                    <div class="page-content">
                        ...
                        <div class="page-bar">
                            <ul class="page-breadcrumb">
                                <li>
                                 DELETE STATUS SETTING FOR MANAGER
 ...
 <div class="col-md-6">
                                ...
                                <div class="portlet box blue">
                                    ...
                                    <div class="portlet-body form">
                                             {!! Form::open(['url' =>'adminDeleteSettingInfo','method' => 'post','role' => 'form','class'=>'form-horizontal','files' => true]) !!}
                                            <div class="form-body">
                                                  ...
                                                  <div class="form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                        <select  class="form-control spinner" name="opd_status" required="">
                                                          ...
                                                          <option value="1">Not Allowed Delete For Manager </option>
                                                          <option value="2">Allowed Delete For Manager</option>
                                                        <?php else:?>
