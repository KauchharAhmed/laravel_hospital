...
<body> 
	...
	<table width="100%" border="1px;">
	  ...
	  <tr style="border: 0px;">
            ...
            <td style="border: 0px;">: <span style="padding-left:50px;">IPD Service</span></td>
		</tr>
		<tr style="border: 0px;">
            ...
            <td style="border: 0px;">: <span style="padding-left:50px;"><strong><?php echo " IPDS- ". $row->invoice ; ?></strong></span> </td>
		</tr>
			<tr style="border: 0px;">
	...
	<table width="100%" border="1px;">
          ...
          <?php
          $bill_barcode_info = "IPDS-".$row->invoice;
