...
<body> 
	...
	<table width="100%" border="1px;">
       ...
       <tr style="border: 0px;">
	    ...
	    <tr style="border: 0px;">
            ...
            <td style="border: 0px;">: <span style="padding-left:50px;">IPD Clearance</span></td>
		</tr>
		<tr style="border: 0px;">
            ...
            <td style="border: 0px;">: <span style="padding-left:50px;"><strong><?php echo " IPDC- ". $row->invoice ; ?></strong></span> </td>
		</tr>
			<tr style="border: 0px;">
            ...
            <td style="border: 0px;">Admit No</td>
            <td style="border: 0px;">: <span style="padding-left:50px;"><?php echo $ipd_admission_info->invoice;?></span></td>
		</tr>
			<tr style="border: 0px;">
			<td style="border: 0px;">Address </td>
            <td style="border: 0px;">:<span style="padding-left:50px;"><?php echo $row->address;?></span></td>
            <td style="border: 0px;">Admit Date<strong></strong></td>
            <td style="border: 0px;">:<span style="padding-left:50px;"><?php echo date('d M Y',strtotime($ipd_admission_info->admit_date));?></span></td>
		</tr>
			<tr style="border: 0px;">
            ...
            <td style="border: 0px;">Clearance Date<strong></strong></td>
            <td style="border: 0px;">:<span style="padding-left:50px;"><?php echo date('d M Y',strtotime($ipd_admission_info->end_date));?></span></td>
		</tr>
		    <?php if($room_type == '1'):?>
			<tr style="border: 0px;">
			<td style="border: 0px;"><strong></strong> </td>
            <td style="border: 0px;"><strong><span style="padding-left:50px;"> </strong></td>
	...
	<?php elseif($room_type == '2'):?>
			<tr style="border: 0px;">
			<td style="border: 0px;"><strong> </strong> </td>
            <td style="border: 0px;"></span> </strong></td>
            <td style="border: 0px;">Building / Floor</td>
	...
	<table width="100%" border="1px;">
          ...
          <?php
          $bill_barcode_info = "IPDC-".$row->invoice;
...
<table width="100%" class="roni">
		...
		<?php $j = 1 ; 
			...
			<tr>
			 ...
			 $total_discount = 0 ;
			 $total_rebate   = 0 ;
			 foreach ($total_ledger_calculation as $ipd_ledger) {
			 $total_payable  = $total_payable + $ipd_ledger->payable_amount ;
			 $total_payment  = $total_payment + $ipd_ledger->payment_amount ;
			 $total_discount = $total_discount + $ipd_ledger->discount ;
			 $total_rebate = $total_rebate + $ipd_ledger->rebate ;
			 }
           ?>
