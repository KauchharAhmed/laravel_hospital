...
<body>
   <strong><table>
      ...
      <center><h3><span style="font-family:tahoma;border:1px solid #000;padding-top:4px;padding-bottom:4px;padding-left:27px;padding-right:27px;">PATHOLOGY BILL REPORT</span></h3></center>      
      <div class="row">
          <table style="font-size:12px;">
                                    <tr>
                                        <td><strong> PATHOLOGY BILL REPORT BETWEEN FROM <?php echo date('d M Y',strtotime($from_date)) ;?> TO <?php echo date('d M Y',strtotime($to_date)) ; ?> 
                                        </strong></td>
...
<?php $i = 1 ;
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="nila"><?php echo "PAT- ". $value->invoice ; ?></td>
