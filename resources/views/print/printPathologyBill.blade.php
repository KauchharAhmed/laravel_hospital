...
<table width="100%">
	...
	<table width="95%" border="1px;" style="font-size: 11px;font-family:tahoma;">
		...
		<tr style="border: 0px;">
            ...
            <td style="border: 0px;"><strong></strong></td>
            <td style="border: 0px;">Bill Date <span style="padding-left: 19px;">:</span> <?php echo date('d-M-Y',strtotime($row->bill_date)) ; ?></td>
            <td style="border: 0px;"></td>
		</tr>
		<tr style="border: 0px;">
			<td style="border: 0px;">Mobile : <?php echo $row->patient_mobile ; ?></td>
            <td style="border: 0px;"><strong></strong></td>
            <td style="border: 0px;">Report Date : <?php echo date('d-M-Y',strtotime($row->report_date)) ; ?></td>
            <td style="border: 0px;"></td>
		</tr>
		<tr style="border: 0px;">
			<td style="border: 0px;">Age <span style="padding-left: 13px;">:</span> <?php echo $row->patient_age ; ?></td>
            <td style="border: 0px;"><strong></strong></td>
            <td style="border: 0px;">Ref By <span style="padding-left: 27px;">:</span> <?php 
            // get doctor info
		...
		<tr style="border: 0px;">
            ...
            <td style="border: 0px;"><strong></strong></td>
            <td style="border: 0px;">Bill Type <span style="padding-left: 17px;">:</span> Pathology</td>
            <td style="border: 0px;"></td>
		</tr>
		<tr style="border: 0px;">
			<td style="border: 0px;">Patient Id : <?php echo $row->patient_number;?></td>
            <td style="border: 0px;"><strong></strong></td>
            <td style="border: 0px;font-weight: bold;">Bill No <span style="padding-left: 22px;">:</span> <?php echo "#". $row->invoice ; ?></td>
            <td style="border: 0px;"></td>
		</tr>
			<tr style="border: 0px;">
			<td style="border: 0px;">Tr. Date <span style="padding-left: 6px;"> :</span> <?php echo date('d-M-Y',strtotime($bill_last_tr_no->tr_date)) ; ?></td>
            <td style="border: 0px;"><strong></strong></td>
	...
	<table width="95%" border="1px;" style="font-size: 11px;">
        ...
        <?php
          $bill_barcode_info = "PATHOLOGY-".$row->invoice;
        ?>
...
<table width="47%" style="position: fixed;bottom: 30px;" class="rayhan">
	...
	<table width="95%" border="1px;" style="font-size: 11px;font-family:tahoma;">
		...
		<tr style="border: 0px;">
			<td style="border: 0px;">Age <span style="padding-left: 13px;">:</span> <?php echo $row->patient_age ; ?></td>
            <td style="border: 0px;"><strong></strong></td>
            <td style="border: 0px;">Ref By <span style="padding-left: 27px;">:</span> <?php $doctor_query = DB::table('admin')->where('id',$row->doctor_id)->first();
