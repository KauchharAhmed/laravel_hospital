...
<body> 
	...
	<table width="100%" border="1px;">
	  ...
	  <tr style="border: 0px;">
		...
		<tr style="border: 0px;">
            ...
            <td style="border: 0px;">: <span style="padding-left:50px;">Pathology</span></td>
		</tr>
			<tr style="border: 0px;">
            ...
            <td style="border: 0px;">: <span style="padding-left:50px;"><strong><?php echo " PAT- ". $row->invoice ; ?></strong></span></td>
		</tr>
	...
	<table width="100%" border="1px;">
          ...
          <?php
          $bill_barcode_info = "PAT-".$row->invoice;
