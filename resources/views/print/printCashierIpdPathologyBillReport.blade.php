...
<body>
   <strong><table>
      ...
      <center><h3><span style="font-family:tahoma;border:1px solid #000;padding-top:4px;padding-bottom:4px;padding-left:27px;padding-right:27px;">IPD PATHOLOGY BILL REPORT</span></h3></center>      
      <div class="row">
          <table style="font-size:12px;">
                                    <tr>
                                        <td><strong> IPD PATHOLOGY BILL REPORT BETWEEN FROM <?php echo date('d M Y',strtotime($from_date)) ;?> TO <?php echo date('d M Y',strtotime($to_date)) ; ?> 
                                        </strong></td>
  ...
  <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    echo "IPDA- ".$ipd_admit_query->invoice ;
                                                     ?></td>
                                                    <td class="nila"><?php echo "IPDP- ".$value->invoice ; ?></td>
