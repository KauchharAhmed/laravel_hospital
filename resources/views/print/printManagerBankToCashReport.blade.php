...
<body>
   <strong><table>
    ...
    ?>
      ...
      <center><h3><span style="font-family:tahoma;border:1px solid #000;padding-top:4px;padding-bottom:4px;padding-left:27px;padding-right:27px;">BANK TO CASH REPORT </span></h3></center>      
      <div class="row">
          <table style="font-size:12px;">
                                    <tr>
                                        <td><strong>BANK TO CASH REPORT BETWEEN FROM <?php echo date('d M Y',strtotime($from_date)) ;?> TO <?php echo date('d M Y',strtotime($to_date)) ; ?>
                                          <?php if($bank !=''){
...
<table width="100%" class="nila">
  ...
  <tbody>
                                                <?php $i = 1 ;
                                                $total_send_amount_amount = 0 ;
                                                foreach ($result as $value) {
                                                 $total_send_amount_amount = $total_send_amount_amount + $value->send_amount ;
                                                  ?>
                                                <tr>
                                                ...
                                                <tr>
                                                    <td colspan="7" class="nila"><strong>TOTAL</strong></td>
                                                     <td class="nila"><strong><?php echo number_format($total_send_amount_amount,2);?></strong></td>
