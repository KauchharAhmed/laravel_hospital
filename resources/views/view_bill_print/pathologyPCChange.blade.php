...
{!! Form::open(['url' => 'changePathologyPcAmountInfo','role' => 'form','class'=>'form-horizontal']) !!}
 <div class="row">
 ...
 <div class="col-md-6">
                                ...
                                <div class="portlet box blue">
                                    <div class="portlet-title">
                                        <div class="caption">
                                          Change To PC In Pathology Bill
                                       </div>
                                    </div>
                                            ...
                                            <div class="form-body"> 
                                                  <div class="form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                        ...
                                                        <?php
                                                       if($pathology_query->pc_id == '0')
                                                       {
                                                        $pc_is = 'HOSPITAL';
                                                        $pc_id_is = '0';
                                                       }else{
                                                       $pc_info_query = DB::table('tbl_pc')->where('id',$pathology_query->pc_id)->first();
                                                ...
                                                <input type="hidden" name="bill_date" value="<?php echo $pathology_query->bill_date;?>" required="">
                                                <input type="hidden" name="total_bill_amt" value="<?php echo $total_payable;?>" required="">
                                                <input type="hidden" name="patient_id" value="<?php echo $pathology_query->patient_id;?>" required="">
                                                <input type="hidden" name="previous_pc_id" value="<?php echo $pathology_query->pc_id;?>" required="">
                                    ...
                                    <div class="portlet-body form"> 
                                            <div class="form-body"> 
                                                  <div class="form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input type="text" class="form-control spinner" readonly="" style="border: none;background: white;" value="<?php echo date('d M Y',strtotime($pathology_query->bill_date));?> - <?php echo date('h:i:s a',strtotime($pathology_query->bill_time));?>"></div>
                                                </div>  
                                                 <div class="form-group">
                                                    <label class="col-md-4 control-label"> <strong>Bill No </strong></label>
                                                    <div class="col-md-8">
                                                         <strong> <input type="text" class="form-control spinner" readonly="" style="border: none;background: white;" value="<?php echo "PAT - ".$pathology_query->invoice;?>"> </strong></div>
                                                </div>

                                                 <div class="form-group">
                                                    <label class="col-md-4 control-label">Patient  Info</label>
                                                    <div class="col-md-8">
                                                        <textarea class="form-control spinner" rows="3" cols="3" style="border: none;background: white;"><?php echo $pathology_query->patient_name.' - '.$pathology_query->patient_number.' - '.$pathology_query->patient_mobile.' - '.$pathology_query->patient_address ?></textarea>
                                                    </div>
                                                </div>
                                                  <div class="form-group">
