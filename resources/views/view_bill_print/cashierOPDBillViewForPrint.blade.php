                                ...
                                <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class="caption font-dark">
                                          ...
                                          ?>
                                          OPD BILL LIST BETWEEN FROM <?php echo date('d M Y',strtotime($from_date)) ;?> TO <?php echo date('d M Y',strtotime($to_date)) ; ?>
                                            </span>
                                              </div> 
                                    </div>
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <?php
                                                    // get tr info
                                                $pathology_tr_query = DB::table('opd_bill_transaction')->where('branch_id',$branch_id)->where('invoice_number',$value->invoice)->get(); 
                                                $total_payable  = 0 ;
                                                $total_discount = 0 ;
                                                $total_rebate = 0 ;
                                                $total_payment = 0 ;
                                                    ...
                                                    // return amount
                                                    $pathology_return_amount = DB::table('opd_bill_transaction')->where('branch_id',$branch_id)->where('invoice_number',$value->invoice)->where('status',2)->get(); 
                                                    ...
                                                    <td><?php echo number_format($total_payment - $total_return_amount,2)  ;  ?></td> 
                                                     <td>
                                                      <a target="_blank" href="{{URL::to('printA4OpdBill/'.$value->invoice.'/'.$value->id)}}"><button type="button" class="btn btn-info btn-sm">PRINT INVOICE</button></a>  
                                                      </td>
                                                </tr>
                                                <?php } ?>
