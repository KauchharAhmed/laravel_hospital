                                ...
                                <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class="caption font-dark">
                                          ...
                                          ?>
                                          IPD SERVICE BILL LIST BETWEEN FROM <?php echo date('d M Y',strtotime($from_date)) ;?> TO <?php echo date('d M Y',strtotime($to_date)) ; ?>
                                            </span>
                                              </div> 
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a target="_blank" href="{{URL::to('printIpdServiceBill/'.$value->id.'/'.$value->invoice.'/'.$value->cashbook_id.'/'.$value->ipd_admission_id)}}"><button type="button" class="btn btn-info btn-sm">PRINT INVOICE</button></a></td>  
                                                </tr>
                                                <?php } ?>
