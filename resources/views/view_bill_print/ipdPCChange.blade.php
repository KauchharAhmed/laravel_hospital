                    ...
                    <div class="page-content">
                        ...
                        <div class="page-bar">
                            <ul class="page-breadcrumb">
                                <li>
                                    CHAGE PC IN IPD CLEARENCE BILL
...
{!! Form::open(['url' => 'changeIPDPcAmountInfo','role' => 'form','class'=>'form-horizontal']) !!}
 <div class="row">
 ...
 <div class="col-md-6">
                                ...
                                <div class="portlet box blue">
                                    <div class="portlet-title">
                                        <div class="caption">
                                          Change To PC In IPD Clearence Bill
                                       </div>
                                    </div>
                                            ...
                                            <div class="form-body"> 
                                                  <div class="form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                        ...
                                                        <?php
                                                       if($ipd_query->pc_id == '0')
                                                       {
                                                        $pc_is = 'HOSPITAL';
                                                        $pc_id_is = '0';
                                                       }else{
                                                       $pc_info_query = DB::table('tbl_pc')->where('id',$ipd_query->pc_id)->first();
                                                ...
                                                <input type="hidden" name="bill_date" value="<?php echo $ipd_query->bill_date;?>" required="">
                                                <input type="hidden" name="total_bill_amt" value="<?php echo $total_payable;?>" required="">
                                                <input type="hidden" name="patient_id" value="<?php echo $ipd_query->patient_id;?>" required="">
                                                <input type="hidden" name="previous_pc_id" value="<?php echo $ipd_query->pc_id;?>" required="">
                                                <input type="hidden" name="previous_pc_amount" value="<?php echo $pc_amount;?>" required="">
                                                <input type="hidden" name="ipd_admission_id" value="<?php echo $ipd_admission_id;?>" required="">
                                    ...
                                    <div class="portlet-body form"> 
                                            <div class="form-body"> 
                                                  <div class="form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input type="text" class="form-control spinner" readonly="" style="border: none;background: white;" value="<?php echo date('d M Y',strtotime($ipd_query->bill_date));?> - <?php echo date('h:i:s a',strtotime($ipd_query->bill_time));?>"></div>
                                                </div>  
                                                 <div class="form-group">
                                                    <label class="col-md-4 control-label"> <strong>Bill No </strong></label>
                                                    <div class="col-md-8">
                                                         <strong> <input type="text" class="form-control spinner" readonly="" style="border: none;background: white;" value="<?php echo "IPDC - ".$ipd_query->invoice;?>"> </strong></div>
                                                </div>

                                                 <div class="form-group">
                                                    <label class="col-md-4 control-label">Patient  Info</label>
                                                    <div class="col-md-8">
                                                        <textarea class="form-control spinner" rows="3" cols="3" style="border: none;background: white;"><?php echo $ipd_query->patient_name.' - '.$ipd_query->patient_number.' - '.$ipd_query->patient_mobile.' - '.$ipd_query->patient_address ?></textarea>
                                                    </div>
                                                </div>
                                                  <div class="form-group">
