                    ...
                    <div class="page-content">
                        ...
                        <div class="page-bar">
                            <ul class="page-breadcrumb">
                                <li>
                                DOCTOR DISCOUNT IN PATHOLOGY BILL
 ...
 <div class="col-md-6">
                                ...
                                <div class="portlet box blue">
                                    ...
                                    <div class="portlet-body form">
                                             {!! Form::open(['url' =>'pathologyDoctorDiscountInfo','method' => 'post','role' => 'form','class'=>'form-horizontal']) !!}
                                            <div class="form-body">
                                                    ...
                                                    <div class="col-md-8">
                                                        <select class="form-control spinner selectpicker" data-live-search="true" name="invoice" id="invoice" required="">
                                                          ...
                                                          <?php foreach ($paid_invoice as $paid_invoice_value) {?>
                                                            <option value="<?php echo $paid_invoice_value->invoice ?>">PAT - # <?php echo $paid_invoice_value->invoice;?></option>
                                                          <?php } ?>
                                                        </select>
                                                </div>
                                              </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                        <button type="submit" class="btn green">Pathology Doctor Discount</button>
                                                    </div>
                                                </div>
                                        {!! Form::close() !!}
                                </div>
...
<script>
    $('#invoice').change(function(e){
      ...
      $("[name=invoice]").change(function(e){
       ...
       $.ajax({
        'url':"{{ url('/getInvoiceCalculationForPathologyDiscount') }}",
        'type':'post',
        'dataType':'text',
        data:{  
        invoice:invoice
