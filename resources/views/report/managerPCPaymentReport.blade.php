                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-2">
                                                      ...
                                                      <label class="col-md-1 control-label">To <span style="color:red; font-weight: bold">*</span></label>
                                                       ...
                                                       <label class="col-md-1 control-label">PC</label>
                                                        <div class="col-md-2">
                                                         <select class="form-control spinner selectpicker" data-live-search="true" id="pc">
                                                           <option value="">All</option>
                                                           <?php foreach ($pc as $pc_value) { ?>
                                                           <option value="<?php echo $pc_value->id;?>">
                                                             <?php echo $pc_value->name ;?>
                                                             -><?php echo $pc_value->mobile ;?>
                                                             -><?php echo $pc_value->address ;?>
                                                          </option>
                                                           <?php } ?>
                                                         </select>
                                                      </div>
...
@section('js')
   <script>
     $('#report').click(function(e){
       ...
       $.ajax({
        'url':"{{ url('/managerPCPaymentReportView') }}",
        'type':'post',
        'dataType':'text',
        data:{  
        from_date:from_date ,
