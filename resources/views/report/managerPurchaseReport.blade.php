 ...
 <div class="col-md-12">
                                ...
                                <div class="portlet box blue">
                                    <div class="portlet-title">
                                        <div class="caption">
                                          GENERATE PRODUCT PURCHASE REPORT
                                      </div>
                                    </div>
                                                    ...
                                                    <div class="col-md-2">
                                                      ...
                                                      <label class="col-md-1 control-label">To <span style="color:red; font-weight: bold">*</span></label>
                                                       ...
                                                       <label class="col-md-1 control-label">Supplier</label>
                                                        <div class="col-md-2">
                                                         <select class="form-control spinner selectpicker" data-live-search="true" id="supplier">
                                                           <option value="">All</option>
                                                           <?php foreach ($supplier as $supplier_value) { ?>
                                                           <option value="<?php echo $supplier_value->id;?>">
                                                             <?php echo $supplier_value->supplier_name ;?>
                                                             -><?php echo $supplier_value->mobile ;?>
                                                             -><?php echo $supplier_value->address ;?>
                                                          </option>
                                                           <?php } ?>
...
@section('js')
   <script>
     $('#report').click(function(e){
       ...
       $.ajax({
        'url':"{{ url('/managerPurchaseReportView') }}",
        'type':'post',
        'dataType':'text',
        data:{  
        from_date:from_date ,
