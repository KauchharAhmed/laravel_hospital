                                                    ...
                                                    <div class="col-md-2">
                                                      ...
                                                      <label class="col-md-1 control-label">To <span style="color:red; font-weight: bold">*</span></label>
                                                       ...
                                                       <label class="col-md-1 control-label">Category</label>
                                                        <div class="col-md-2">
                                                         <select class="form-control spinner selectpicker" data-live-search="true" id="expense">
                                                           <option value="">All</option>
                                                           <?php foreach ($expense as $expense_value) { ?>
                                                           <option value="<?php echo $expense_value->id;?>">
                                                             <?php echo $expense_value->expense_name ;?>
                                                          </option>
                                                           <?php } ?>
                                                         </select>
                                                      </div>
...
@section('js')
   <script>
     $('#report').click(function(e){
       ...
       $.ajax({
        'url':"{{ url('/managerExpenseReportView') }}",
        'type':'post',
        'dataType':'text',
        data:{  
        from_date:from_date ,
