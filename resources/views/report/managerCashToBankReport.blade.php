                                                    ...
                                                    <div class="col-md-2">
                                                      ...
                                                      <label class="col-md-1 control-label">To <span style="color:red; font-weight: bold">*</span></label>
                                                       ...
                                                       <label class="col-md-1 control-label">Bank</label>
                                                        <div class="col-md-2">
                                                         <select class="form-control spinner selectpicker" data-live-search="true" id="bank">
                                                           <option value="">All</option>
                                                           <?php foreach ($bank as $bank_value) { ?>
                                                           <option value="<?php echo $bank_value->id;?>">
                                                             <?php echo $bank_value->bank_name ;?>
                                                             -><?php echo $bank_value->branch ;?>
                                                             -><?php echo $bank_value->account_no ;?>
                                                          </option>
                                                           <?php } ?>
                                                         </select>
                                                      </div>
...
@section('js')
   <script>
     $('#report').click(function(e){
       ...
       $.ajax({
        'url':"{{ url('/managerCashToBankReportView') }}",
        'type':'post',
        'dataType':'text',
        data:{  
        from_date:from_date ,
