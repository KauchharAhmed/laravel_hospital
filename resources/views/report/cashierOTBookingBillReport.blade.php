                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-2">
                                                      ...
                                                      <label class="col-md-1 control-label">To <span style="color:red; font-weight: bold">*</span></label>
                                                       ...
                                                       <label class="col-md-1 control-label">OT Type</label>
                                                        <div class="col-md-2">
                                                         <select class="form-control spinner selectpicker" data-live-search="true" id="ot_type">
                                                           <option value="">All</option>
                                                           <?php foreach ($ot_type as $value) { ?>
                                                           <option value="<?php echo $value->id;?>">
                                                             <?php echo $value->ot_type ;?>
                                                          </option>
                                                           <?php } ?>
...
@section('js')
   <script>
     $('#report').click(function(e){
       ...
       $.ajax({
        'url':"{{ url('/cashierOTBookingBillReportView') }}",
        'type':'post',
        'dataType':'text',
        data:{  
        from_date:from_date ,
